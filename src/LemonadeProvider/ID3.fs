...
module ID3Reader =
  ...
  let private readMCDIFrame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> MCDI)
  ...
  let private readTALBFrame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TALB)
  let private readTIT1Frame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TIT1)
  let private readTIT2Frame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TIT2)
  let private readTIT3Frame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TIT3)
  let private readTRCKFrame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TRCK)
  let private readTYERFrame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TYER)
  let private readTPE1Frame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TPE1)
  let private readTPE2Frame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TPE2)
  let private readTPOSFrame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TPOS)
  let private readTPUBFrame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TPUB)
  let private readTCOMFrame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TCOM)
  let private readTCONFrame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TCON)
  let private readTCOPFrame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TCOP)
  let private readTLENFrame (bytes: byte[]) = bytes |> (Encoding.ASCII.GetString >> TLEN)
  ...
  let readID3Frames filename =
    use reader = filename |> openFileForRead |> createBinaryReader
